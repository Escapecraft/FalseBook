...
public class MC2111 extends BaseIC {
   ...
   public void Execute(Sign signBlock, InputState currentInputs, InputState previousInputs) {
      ...
      if(!input1High && !input2High) {
         ...
         MC2111.SchedulerClass newSched1 = new MC2111.SchedulerClass(this, signBlock.getBlock().getLocation());
