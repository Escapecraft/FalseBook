...
public class MC1240 extends BaseIC {
   ...
   public void Execute(Sign signBlock, InputState currentInputs, InputState previousInputs) {
      if(currentInputs.isInputOneHigh() && previousInputs.isInputOneLow()) {
         ...
         Vector velocity1 = new Vector(0.0F, 1.0F, 0.0F);
         if(dir == 1) {
            velocity1 = new Vector(0.0F, vertVel, -1.0F);
         } else if(dir == 2) {
            velocity1 = new Vector(-1.0F, vertVel, 0.0F);
         } else if(dir == 3) {
            velocity1 = new Vector(0.0F, vertVel, 1.0F);
         } else if(dir == 4) {
            velocity1 = new Vector(1.0F, vertVel, 0.0F);
         ...
         arrow.shoot(velocity1.getX(), velocity1.getY(), velocity1.getZ(), speed, spread);
