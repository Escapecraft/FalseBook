   ...
   public void Execute(Sign signBlock, InputState currentInputs, InputState previousInputs) {
      if(currentInputs.isInputOneHigh() && previousInputs.isInputOneLow()) {
         ...
         while(pulseCount.hasNext()) {
            MC2501.SchedulerClass pulseLength = (MC2501.SchedulerClass)pulseCount.next();
         ...
         MC2501.SchedulerClass newSched1 = new MC2501.SchedulerClass(this, signBlock.getBlock().getLocation(), pulseLength1, pulseCount1, pauseLength);
