   ...
   public void Execute(Sign signBlock, InputState currentInputs, InputState previousInputs) {
      if(currentInputs.isInputOneLow() && previousInputs.isInputOneHigh()) {
         ...
         while(pulseCount.hasNext()) {
            MC2511.SchedulerClass pulseLength = (MC2511.SchedulerClass)pulseCount.next();
         ...
         MC2511.SchedulerClass newSched1 = new MC2511.SchedulerClass(this, signBlock.getBlock().getLocation(), pulseLength1, pulseCount1, pauseLength);
