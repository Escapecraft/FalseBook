   ...
   public void Execute(Sign signBlock, InputState currentInputs, InputState previousInputs) {
      if(currentInputs.isInputOneHigh() && previousInputs.isInputOneLow()) {
         ...
         while(pulseCount.hasNext()) {
            MC2500.SchedulerClass pulseLength = (MC2500.SchedulerClass)pulseCount.next();
         ...
         MC2500.SchedulerClass newSched1 = new MC2500.SchedulerClass(this, signBlock.getBlock().getLocation(), pulseLength1, pulseCount1, pauseLength);
