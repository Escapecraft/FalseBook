...
public class ValueDoubleList {
   ...
   public ValueDoubleList(String name, String importString) {
      ...
      for(int var5 = 0; var5 < var6; ++var5) {
         ...
         try {
            this.addValue((double)Integer.valueOf(part).intValue());
   ...
   public boolean hasValue(double value) {
      ...
      while(var4.hasNext()) {
         ValueDouble thisValue = (ValueDouble)var4.next();
   ...
   public ValueDouble addValue(String name, double value) {
      return this.addValue(new ValueDouble(name, value));
   }

   public ValueDouble addValue(double value) {
      return this.addValue(new ValueDouble("" + (this.valueList.size() + 1), value));
   }
   ...
   public double getValue(int index) {
      try {
         return ((ValueDouble)this.valueList.get(index)).getValue();
