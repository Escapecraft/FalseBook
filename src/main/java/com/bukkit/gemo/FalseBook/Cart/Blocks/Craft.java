            ...
            if(nowCraft != null) {
               ...
               for(int res = 0; res < var20.length; ++res) {
                  if(var20[res] != null && var20[res].getTypeId() != Material.AIR.getId()) {
                     var21.setItem(res, new net.minecraft.server.v1_6_R3.ItemStack(var20[res].getTypeId(), var20[res].getAmount(), var20[res].getDurability()));
                  }
               }

               net.minecraft.server.v1_6_R3.ItemStack var22 = null;
                  ...
                  for(result = 0; result < 9; ++result) {
                     if(var21.getItem(result) != null && var21.getItem(result).id != Material.AIR.getId()) {
                        ...
                        if(var21.getItem(result).count < 1) {
                           var21.setItem(result, (net.minecraft.server.v1_6_R3.ItemStack)null);
                        }
                     }
                  }
